        ...
        <table className="w-full text-left border-collapse table-fixed min-w-[700px]">
          <thead className="bg-gray-100 border-b border-gray-300">
            <tr>
              ...
              <th className="px-3 py-2 text-[9px] font-black uppercase tracking-widest w-[120px] text-center border-r border-gray-200">Qualification</th>
              ...
              <th className="px-3 py-2 text-[9px] font-black uppercase tracking-widest w-[70px] text-center">Info</th>
            </tr>
          </thead>
              ...
              return (
                <tr key={job.id} className="hover:bg-blue-50/50 transition-colors group">
                  ...
                  <td className="px-3 py-2 text-center border-r border-gray-100">
                    <span className="text-[9px] font-bold text-blue-800 uppercase bg-blue-50 px-2 py-0.5 rounded truncate inline-block max-w-full">
