        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            ...
            <div className="mt-12 p-8 bg-blue-50 border border-blue-200 rounded-xl relative overflow-hidden">
                ...
                <p className="text-xs text-blue-800 leading-loose mb-6 font-medium">
                ...
                <div className="flex flex-wrap gap-4 pt-4 border-t border-blue-100">
                    <a href={job.externalLink} target="_blank" rel="noopener noreferrer" className="text-[10px] font-black uppercase text-blue-700 underline decoration-blue-300 decoration-2 underline-offset-4 active:text-blue-900">Official Portal Link</a>
                    <a href="/privacy-policy" className="text-[10px] font-black uppercase text-blue-700 underline decoration-blue-300 decoration-2 underline-offset-4 active:text-blue-900">Editorial Policy</a>
                </div>
            </div>
          </div>
